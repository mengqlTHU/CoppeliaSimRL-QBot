...
if __name__ == "__main__":
    ...
    callback_visdom = VisdomCallback(name='visdom_qbot_ppo_tcontrol', check_freq=100, log_dir=log_dir)
    ...
    model = PPO(policy='MlpPolicy', env=env, learning_rate=3e-4, verbose=True)
